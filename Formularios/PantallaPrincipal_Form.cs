...
namespace Aerolinea
{
    public partial class PantallaPrincipal_Form : Form
    {
        ...
        public void Usuario_DataGridView()
        {
            ...
            DataTable usuario_select_tabla = usuario.PopularTablaUsuario();
        ...
        private void PopularTablaVuelos()
        {
            ...
            tiquetes_Table_VuelosDisponibles.DataSource = vuelo.RetornaTablaVuelos().Tables[0];
        ...
        private void PopularTablaHistorial() 
        {
            ...
            historial_Table_TiquetesHistorial.DataSource = historial.RetornaTablaHistorial();
        }

        private void PopularTablaCheckIn()
        {
            CheckIn checkIn = new CheckIn();
            checkIn_Tabla_TiquetesSinRegistro.DataSource = checkIn.RetornaTablaCheckIn();
            tiquetes_Table_VuelosDisponibles.CurrentCell = null;
        }
        ...
        private void tiquetes_Button_ElegirAsiento(object sender, EventArgs e)
        {
            ...
            } else
            {
                ...
                if (!usuario.UsuarioExiste(usuario.Cedula))
                {
                ...
                } else
                {
                    ...
                    bool existe = usuario.RegistroExisteEnBD(usuario.Cedula, usuario.Nombre, usuario.PrimerApellido, usuario.SegundoApellido, fechaParaRevision, usuario.NumeroTelefono, conexion);
        ...
        private void checkIn_Button_BuscarTiquetes_Click(object sender, EventArgs e)
        {
            ...
            else if (checkIn_ComboBox_BusquedaPor.Text == "Número de Tiquete")
            {
                ...
                checkIn_Tabla_TiquetesSinRegistro.DataSource = tiquete.BuscaTiquetePorNumeroDeTiquete(Convert.ToInt32(checkIn_TextBox_ElementoABuscar.Text), 1).Tables[0];
            }
            else if (checkIn_ComboBox_BusquedaPor.Text == "Cédula")
            {
                checkIn_Tabla_TiquetesSinRegistro.DataSource = tiquete.BuscaTiquetePorCedula(checkIn_TextBox_ElementoABuscar.Text, 1).Tables[0];
            }
            else if (checkIn_ComboBox_BusquedaPor.Text == "Nombre")
            {
                checkIn_Tabla_TiquetesSinRegistro.DataSource = tiquete.BuscaTiquetePorNombre(checkIn_TextBox_ElementoABuscar.Text, 1).Tables[0];
            }
            else if (checkIn_ComboBox_BusquedaPor.Text == "Primer Apellido")
            {
                
                checkIn_Tabla_TiquetesSinRegistro.DataSource = tiquete.BuscaTiquetePorPrimerApellido(checkIn_TextBox_ElementoABuscar.Text, 1).Tables[0];
            }
            else //Segundo Apellido
            {
                checkIn_Tabla_TiquetesSinRegistro.DataSource = tiquete.BuscaTiquetePorSegundoApellido(checkIn_TextBox_ElementoABuscar.Text, 1).Tables[0];
            }
        }
        ...
        private void checkIn_Button_Anular_Click(object sender, EventArgs e)
        {
            ...
            if (resultado.ToString().Trim() == "Yes")
            {
                ...
                tiquete.AnulaTiquete(numeroDeTiquete, nombreDeRuta);
        ...
        private void historial_Button_BuscarTiquete_Click(object sender, EventArgs e)
        {
            ...
            else if (historial_ComboBox_BusquedaPor.Text == "Número de Tiquete")
            {
                ...
                historial_Table_TiquetesHistorial.DataSource = tiquete.BuscaTiquetePorNumeroDeTiquete(Convert.ToInt32(historial_TextBox_ElementoABuscar.Text), 2).Tables[0];

            }
            else if (historial_ComboBox_BusquedaPor.Text == "Cédula")
            {
                historial_Table_TiquetesHistorial.DataSource = tiquete.BuscaTiquetePorCedula(historial_TextBox_ElementoABuscar.Text, 2).Tables[0];
            }
            else if (historial_ComboBox_BusquedaPor.Text == "Nombre")
            {
                historial_Table_TiquetesHistorial.DataSource = tiquete.BuscaTiquetePorNombre(historial_TextBox_ElementoABuscar.Text, 2).Tables[0];;
            }
            else if (historial_ComboBox_BusquedaPor.Text == "Primer Apellido")
            {
                historial_Table_TiquetesHistorial.DataSource = tiquete.BuscaTiquetePorPrimerApellido(historial_TextBox_ElementoABuscar.Text, 2).Tables[0];
            }
            else //Segundo Apellido
            {
                historial_Table_TiquetesHistorial.DataSource = tiquete.BuscaTiquetePorSegundoApellido(historial_TextBox_ElementoABuscar.Text, 2).Tables[0];
            }
        }
        ...
        private void usuarios_Button_RegistrarUsuario_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (String.IsNullOrWhiteSpace(usuarios_TextBox_ID.Text) || 
                    String.IsNullOrWhiteSpace(usuarios_TextBox_Nombre.Text) || 
                    String.IsNullOrWhiteSpace(usuarios_TextBox_Primer_Apellido.Text) || 
                    String.IsNullOrWhiteSpace(usuarios_TextBox_Segundo_Apellido.Text) || 
                    String.IsNullOrWhiteSpace(usuarios_TextBox_Fecha_Nacimiento.Text) || 
                    String.IsNullOrWhiteSpace(usuarios_TextBox_NumDeTel.Text))
                {
                ...
                else
                {
                    ...
                    if (usuario.UsuarioExiste(usuarios_TextBox_ID.Text) == true)
                    {
        ...
        private void usuarios_Button_BuscarUsuarios_Click(object sender, EventArgs e)
        {
            ...
            string Usuario_btnBuscar_SqlCommand = "Sin Comando Asignado"; try
            {
                ...
                {
                    DataTable usuario_select_tabla = usuario.PopularTablaUsuario_UsuarioUnico(Usuario_btnBuscar_SqlCommand);
                    usuarios_Tabla_UsuariosRegistrados.DataSource = usuario_select_tabla;
                }
                else
                {
        ...
        private void historial_Table_TiquetesHistorial_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string descripcionTiquete = tiqueteTemporal.ObtenerDescripcionTiquete(int.Parse(historial_Table_TiquetesHistorial.Rows[historial_Table_TiquetesHistorial.SelectedRows[0].Index].Cells[1].Value.ToString()));
        ...
        {
            Conexion_XML conexión_XML = new Conexion_XML();
            conexión_XML.InformacionContacto_XML();
        }
    }
}
