...
namespace Aerolinea
{
    public class Tiquete
    {
        ...
        public Tiquete(string numeroDeVuelo, string numeroDeAsiento, string fechaTramite, string idUsuario, string metodoDePago, string descripcion)
        {
            ...
            NumeroTiquete = CalcularNumeroTiquete(RealizarConexion_BD());
        ...
        public int CalcularNumeroTiquete(SqlConnection conexion)
        {
        ...
        public DataSet BuscaTiquetePorNumeroDeTiquete(int numeroDeTiquete, int mode)
        {
            string consulta = "";
        ...
        public DataSet BuscaTiquetePorCedula(string cedula, int mode)
        {
            string consulta = "";
        ...
        public DataSet BuscaTiquetePorNombre(string nombre, int mode)
        {
            string consulta = "";
        ...
        public DataSet BuscaTiquetePorPrimerApellido(string primerApellido, int mode)
        {
            string consulta = "";
        ...
        public DataSet BuscaTiquetePorSegundoApellido(string segundoApellido, int mode)
        {
            string consulta = "";
        ...
        public void AnulaTiquete(int numeroDeTiquete, string nombreDeRuta)
        {
            conexion.Open();
        ...
        public void ActualizarPrecioTiquete(int numeroDeTiquete, decimal precioDelTiquete, decimal precioDeLaCompra)
        {
        ...
        public void ActualizarPrecioTiquete(int numeroDeTiquete, decimal precioDelTiquete)
        {
            SqlConnection conexion = objetoConexion.RecibirConexion();
            conexion.Open();
        ...
        public void ActualizarDescuentoTiquete(int numeroDeTiquete, decimal descuento)
        {
            SqlConnection conexion = objetoConexion.RecibirConexion();
            conexion.Open();
        ...
        public void AdicionarDescripcionATiquete(int numeroDeTiquete, string descripcionAAdicionar)
        {
            SqlConnection conexion = objetoConexion.RecibirConexion();
            conexion.Open();
        ...
        public void InsertarTiquete(Tiquete tiquete, string cedulaUsuario)
        {
            SqlConnection conexion = objetoConexion.RecibirConexion();
            conexion.Open();
        ...
        public string ObtenerDescripcionTiquete(int numeroDeTiquete)
        {
            SqlConnection conexion = objetoConexion.RecibirConexion();
            conexion.Open();
