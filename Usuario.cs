...
namespace Aerolinea
{
    public class Usuario
    {
        ...
        public Usuario(string nombre, string primerApellido, string segundoApellido, string cedula, string fechaNacimiento, string numeroTelefono)
        {
            ...
            {
                if (PerteneceProgramaMillas(cedula))
                {
        ...
        public bool PerteneceProgramaMillas(string idUsuario)
        {
        ...
        public bool RegistroExisteEnBD(string id, string nombre, string primerApellido, string segundoApellido, string fecha, string telefono, SqlConnection conexion)
        {
            conexion.Open();
        ...
        public void InsertarUsuario_PostCompra(Usuario usuario, bool adicionarProgramaMillas, int millas = 0)
        {
        ...
        public void ActualizarMillasUsuario(string cedula, int millasAInsertar)
        {
            SqlConnection conexion = RealizarConexion_BD();
            conexion.Open();
        ...
        public DataTable PopularTablaUsuario()
        {
            conexion = RealizarConexion_BD();
            conexion.Open();
        ...
        public DataTable PopularTablaUsuario_UsuarioUnico(string Usuario_btnBuscar_SqlCommand)
        {
            conexion = RealizarConexion_BD();
            conexion.Open();
        ...
        public void ActualizarDatosUsuario(string nombre, string primerApellido, string segundoApellido, string cedula, string fechaDeNacimiento, string numeroDeTelefono, bool perteneceProgramaMillas, string millasAcumuladas)
        {
            SqlConnection conexion = RealizarConexion_BD();
            conexion.Open();
