...
namespace Aerolinea
{
    public class Vuelo
    {
        ...
        public DataSet RetornaTablaVuelos()
        {
        ...
        public void AsignaAsientoPreviamenteCompradoEnLista(string numeroDeTiquete, string numeroDeAsientoPrevio, List<System.Windows.Forms.Label> asientosOcupados)
        {
            SqlConnection conexion = objetoConexion.RecibirConexion();
            conexion.Open();
        ...
        public void AsignaAsientosOcupadosEnLista(string nombreDeRuta, List<System.Windows.Forms.Label> asientosLibres, List<System.Windows.Forms.Label> asientosOcupados, int mode)
        {
        ...
        public void AsignaAsientosOcupadosEnLista(string nombreDeRuta, List<System.Windows.Forms.Label> asientosLibres)
        {
            List<System.Windows.Forms.Label> listaPorDefecto = new List<System.Windows.Forms.Label>();

            AsignaAsientosOcupadosEnLista(nombreDeRuta, asientosLibres, listaPorDefecto, 1);
        }

        public void PasarAsientoAOcupado(int numeroDeTiquete)
        {
            SqlConnection conexion = objetoConexion.RecibirConexion();
            conexion.Open();
        ...
        public void ActualizarNumeroDeAsiento(int numeroDeTiquete, string numeroDeAsiento)
        {
            SqlConnection conexion = objetoConexion.RecibirConexion();
            conexion.Open();
        ...
        public void InsertarNumeroDeAsiento(string nombreDeRuta, Tiquete tiquete)
        {
            SqlConnection conexion = objetoConexion.RecibirConexion();
            conexion.Open();
        ...
        public void ActualizarAsientoOcupado(int numeroDeTiquete, string nombreDeRuta, string numeroDeAsientoViejo, string numeroDeAsientoNuevo)
        {
            SqlConnection conexion = objetoConexion.RecibirConexion();
            conexion.Open();
