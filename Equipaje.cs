...
namespace Aerolinea
{
    class Equipaje
    {
        ...
        public void ActualizarEquipaje(int numeroDeTiquete, double pesoMaleta1, double pesoMaleta2, double pesoMaleta3, double pesoTotal, decimal precioSobrePeso, decimal costoTotal)
        {
        ...
        public void InsertarEquipajeVacio(int numeroDeTiquete)
        {
            SqlConnection conexion = objetoConexion.RecibirConexion();
            conexion.Open();
